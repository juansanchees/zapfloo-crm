...
secao: adicionado
titulo: Conecte um número antes de configurar a IA
---
...
IA. Agentes, listas de teste e políticas de canais já existentes não são
reescritos. Não há migration nem ação de atualização exigida do operador.
