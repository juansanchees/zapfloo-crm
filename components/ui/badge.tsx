...
/**
 * Badge — Nocturne design system.
 * Variants: default (rampa accent), neutral, success, warning, error, info.
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        // shadcn aliases
        secondary: "border-border bg-surface-elevated text-text-muted",
        destructive: "border-transparent bg-error-bg text-error-fg",
