...
const state = vi.hoisted(() => ({ replace: vi.fn(), search: "pipeline=p2&lead=l2", boardIds: [] as Array<string | null> }));
...
beforeEach(() => { state.replace.mockClear(); state.boardIds = []; state.search = "pipeline=p2&lead=l2"; });
