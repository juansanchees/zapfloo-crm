...
1. **Keyword primeiro, jargão depois.** Para quem compra o serviço, priorize "atendente de IA", "WhatsApp", "vendas" e "CRM"; para o público técnico, explicite também "open source" e "self-hosted" antes de qualquer nome interno de subsistema.
...
5. **Transparência de modelo.** Assinatura do serviço, opção self-host, parcerias de infraestrutura e telemetria são declaradas em linguagem humana, nunca escondidas.
...
*Última revisão: 2026-09-22 — assinatura operada como modelo principal; self-host preservado.*
