...
export const DICIONARIO: Traducoes = {
  ...
  "O rótulo faz parte do desenho. Salve o gatilho no botão próprio abaixo.": { es: "La etiqueta forma parte del diseño. Guarda el disparador con su propio botón debajo." },
  "O modo manual inicia pela API ou por uma integração; não dispara sozinho.": { es: "El modo manual se inicia por la API o mediante una integración; no se dispara solo." },
  "As mensagens são enviadas por um canal conectado. Quando houver conversa vinculada, o fluxo mantém o número de origem.": { es: "Los mensajes se envían por un canal conectado. Cuando hay una conversación vinculada, el flujo mantiene el número de origen." },
  "Ver números conectados": { es: "Ver números conectados" },
  "Este gatilho também precisa estar habilitado na seção Follow-up de um agente publicado, com este fluxo selecionado.": { es: "Este disparador también debe estar habilitado en la sección Follow-up de un agente publicado, con este flujo seleccionado." },
  "Vincular ao agente": { es: "Vincular al agente" },
  "Configurar regra de entrada": { es: "Configurar regla de entrada" },
  "Revise a chave e o modelo em outra aba. Seu texto continua aqui para tentar novamente.": { es: "Revisa la clave y el modelo en otra pestaña. Tu texto permanece aquí para volver a intentarlo." },
  "Revisar chaves de IA": { es: "Revisar claves de IA" },
  "Revisar modelo de IA": { es: "Revisar modelo de IA" },
  "Controles do fluxo": { es: "Controles del flujo" },
  "Aumentar zoom": { es: "Acercar" },
  "Diminuir zoom": { es: "Alejar" },
  "Enquadrar fluxo": { es: "Ajustar flujo a la vista" },
  "Alternar bloqueio do fluxo": { es: "Alternar bloqueo del flujo" },
  "Período de testes": { es: "Período de prueba" },
  "Você está no período de testes grátis": { es: "Estás en el período de prueba gratuito" },
  "Seu período de testes terminou": { es: "Tu período de prueba terminó" },
  "Não foi possível consultar o término do período de testes. Recarregue a página.": { es: "No se pudo consultar el final del período de prueba. Recarga la página." },
  "Termina em": { es: "Termina el" },
  "horário de Brasília": { es: "hora de Brasilia" },
  "Tempo restante:": { es: "Tiempo restante:" },
  ...
  "Canal para o teste restrito": { es: "Canal para la prueba restringida" },
  "Selecione um canal conectado": { es: "Selecciona un canal conectado" },
  "Conecte um canal e clique em Conferir canais conectados.": { es: "Conecta un canal y pulsa Comprobar canales conectados." },
  "Este canal já tem outra política de atendimento. Escolha um canal em modo de teste; a configuração existente será preservada.": { es: "Este canal ya tiene otra política de atención. Elige un canal en modo de prueba; se conservará la configuración existente." },
  "Agente ativado somente para os números de teste. Nenhuma mensagem foi enviada.": { es: "Agente activado solo para los números de prueba. No se envió ningún mensaje." },
  "Conferir estado atual": { es: "Comprobar estado actual" },
  "Voltar ao agente": { es: "Volver al agente" },
  "Conexão pronta. Autorize os números de teste e confirme a ativação abaixo.": { es: "Conexión lista. Autoriza los números de prueba y confirma la activación abajo." },
  "Conferir canais conectados": { es: "Comprobar canales conectados" },
  "Ativação restrita confirmada": { es: "Activación restringida confirmada" },
  "A versão revisada foi ativada para os números de teste. Nenhuma mensagem foi enviada por essa ação.": { es: "La versión revisada se activó para los números de prueba. Esta acción no envió ningún mensaje." },
  "O público geral ficou bloqueado nessa ativação. Confira o estado atual e gerencie alterações no CRM.": { es: "El público general quedó bloqueado en esa activación. Comprueba el estado actual y gestiona los cambios en el CRM." },
  "Seu agente já foi configurado": { es: "Tu agente ya está configurado" },
  "Continue pelo CRM para gerenciar os canais existentes.": { es: "Continúa en el CRM para gestionar los canales existentes." },
  "Este agente ainda não foi ativado. Os canais existentes mantêm suas políticas.": { es: "Este agente aún no está activado. Los canales existentes mantienen sus políticas." },
  "Não foi possível carregar os canais. Recarregue a página.": { es: "No se pudieron cargar los canales. Recarga la página." },
  "Continuar para conexão": { es: "Continuar a la conexión" },
  "Objetivo do agente": { es: "Objetivo del agente" },
  "O que você quer que ele ajude a resolver?": { es: "¿Qué quieres que ayude a resolver?" },
  "Resumo do agente": { es: "Resumen del agente" },
  "Defina o objetivo do agente": { es: "Define el objetivo del agente" },
  "Rascunho: nenhum atendimento ativado.": { es: "Borrador: ninguna atención activada." },
  "Voltar ao negócio": { es: "Volver al negocio" },
  "Gerenciar agente existente": { es: "Gestionar agente existente" },
  "Segmento do negócio": { es: "Sector del negocio" },
  "Selecione seu segmento": { es: "Selecciona tu sector" },
  "Criar meu agente": { es: "Crear mi agente" },
  "Autorize pelo menos um número para continuar.": { es: "Autoriza al menos un número para continuar." },
  "Ativar para estes números de teste": { es: "Activar para estos números de prueba" },
  "Ativando…": { es: "Activando…" },
  "Aguardando conexão": { es: "Esperando conexión" },
  "Revise novamente o agente: a configuração ou organização mudou.": { es: "Revisa de nuevo el agente: la configuración o la organización cambió." },
  "Não foi possível ativar. Confira a revisão, a conexão e os números autorizados antes de tentar novamente.": { es: "No se pudo activar. Comprueba la revisión, la conexión y los números autorizados antes de volver a intentarlo." },
  "Não foi possível confirmar a ativação. Recarregue para conferir antes de tentar novamente.": { es: "No se pudo confirmar la activación. Recarga para comprobarla antes de volver a intentarlo." },
  "Aguarde…": { es: "Espera…" },
  "Escolha um modelo de IA": { es: "Elige un modelo de IA" },
  "Ensaio de conversa, sem envio": { es: "Ensayo de conversación, sin envío" },
  "Prévia de texto apenas: não consulta memória ou ferramentas, não envia mensagens e não testa o WhatsApp.": { es: "Solo vista previa de texto: no consulta memoria ni herramientas, no envía mensajes ni prueba WhatsApp." },
  "O teste chama a IA escolhida e pode consumir créditos de API. Preparar e revisar não chamam a IA.": { es: "La prueba llama a la IA elegida y puede consumir créditos de API. Preparar y revisar no llaman a la IA." },
  "Modelo do ensaio": { es: "Modelo del ensayo" },
  "Credencial do ensaio": { es: "Credencial del ensayo" },
  "Credencial disponível deste provedor (organização/instalação)": { es: "Credencial disponible de este proveedor (organización/instalación)" },
  "Credencial disponível": { es: "Credencial disponible" },
  "O catálogo está vazio. Você pode continuar depois e conferir os provedores no CRM.": { es: "El catálogo está vacío. Puedes continuar después y revisar los proveedores en el CRM." },
  "Salve o rascunho antes de preparar, testar ou revisar.": { es: "Guarda el borrador antes de preparar, probar o revisar." },
  "Preparar ensaio": { es: "Preparar ensayo" },
  "Mensagem de exemplo": { es: "Mensaje de ejemplo" },
  "Use dados fictícios. Não inclua senhas nem dados reais de clientes.": { es: "Usa datos ficticios. No incluyas contraseñas ni datos reales de clientes." },
  "Testar mensagem": { es: "Probar mensaje" },
  "O último ensaio não terminou. Aguarde um momento e teste novamente se ele foi interrompido.": { es: "El último ensayo no terminó. Espera un momento y vuelve a probar si se interrumpió." },
  "Não há chave utilizável para este provedor. Configure uma credencial e tente novamente.": { es: "No hay una clave utilizable para este proveedor. Configura una credencial y vuelve a intentarlo." },
  "O orçamento de IA bloqueou este teste. Confira o orçamento no CRM.": { es: "El presupuesto de IA bloqueó esta prueba. Revisa el presupuesto en el CRM." },
  "A IA não concluiu uma resposta válida. O teste não foi aprovado; confira a configuração e tente novamente.": { es: "La IA no completó una respuesta válida. La prueba no fue aprobada; revisa la configuración y vuelve a intentarlo." },
  "Mensagem testada": { es: "Mensaje probado" },
  "Resposta da IA para revisão": { es: "Respuesta de la IA para revisión" },
  "Revisar resposta": { es: "Revisar respuesta" },
  "Resposta revisada. Nenhum atendimento foi ativado.": { es: "Respuesta revisada. No se activó ninguna atención." },
  "Continuar depois": { es: "Continuar después" },
  "Não foi possível carregar o ensaio. Recarregue a página.": { es: "No se pudo cargar el ensayo. Recarga la página." },
  "A configuração ou organização mudou. Recarregue a página para conferir antes de testar novamente.": { es: "La configuración o la organización cambió. Recarga la página para revisarla antes de volver a probar." },
  "Este modelo não está disponível. Confira o catálogo e escolha novamente.": { es: "Este modelo no está disponible. Revisa el catálogo y elige de nuevo." },
  "Esta credencial não está disponível. Confira a chave escolhida.": { es: "Esta credencial no está disponible. Revisa la clave elegida." },
  "Não foi possível concluir. Sua mensagem continua aqui; confira a configuração e tente novamente.": { es: "No se pudo completar. Tu mensaje sigue aquí; revisa la configuración y vuelve a intentarlo." },
  "Caminho anterior: criar o agente e tentar publicar nos canais existentes.": { es: "Flujo anterior: crear el agente e intentar publicarlo en los canales existentes." },
  "Há um ensaio em andamento ou muitas tentativas recentes. Aguarde um minuto antes de testar novamente.": { es: "Hay un ensayo en curso o demasiados intentos recientes. Espera un minuto antes de volver a probar." },
  "A organização ou a sessão mudou em outra aba. Copie suas alterações e recarregue a página antes de salvar.": { es: "La organización o la sesión cambió en otra pestaña. Copia tus cambios y recarga la página antes de guardar." },
  "Não foi possível carregar seu rascunho. Recarregue a página antes de continuar.": { es: "No se pudo cargar tu borrador. Recarga la página antes de continuar." },
  "Salve nome, jeito de falar e regras para continuar depois. Não precisa de chave de IA e não ativa atendimento.": { es: "Guarda el nombre, el tono y las reglas para continuar después. No necesita clave de IA y no activa la atención." },
  "Este rascunho mudou em outra aba. Copie suas alterações e recarregue a página para conferir a versão salva.": { es: "Este borrador cambió en otra pestaña. Copia tus cambios y recarga la página para revisar la versión guardada." },
  "Confira o nome (2 a 80 caracteres) e as regras (até 20.000 caracteres).": { es: "Revisa el nombre (2 a 80 caracteres) y las reglas (hasta 20.000 caracteres)." },
  "Não foi possível salvar. Seus campos continuam aqui; confira seu acesso antes de tentar novamente.": { es: "No se pudo guardar. Tus campos siguen aquí; revisa tu acceso antes de volver a intentarlo." },
  ...
  Administração: { es: "Administración" },
  "Tarefas e agenda": { es: "Tareas y agenda" },
  "Instâncias WhatsApp": { es: "Instancias de WhatsApp" },
  "Funis de vendas": { es: "Embudos de ventas" },
  Nuvemshop: { es: "Nuvemshop" },
  "Usuários e permissões": { es: "Usuarios y permisos" },
  "Plano e pagamentos": { es: "Plan y pagos" },
  ...
  "Painel de controle": { es: "Panel de control" },
  Crescimento: { es: "Crecimiento" },
  "Fluxos e follow-ups": { es: "Flujos y seguimientos" },
  "Entradas e webhooks": { es: "Entradas y webhooks" },
  "Crie manualmente ou descreva o que precisa. A IA monta um rascunho para você revisar antes de publicar.": { es: "Créalo manualmente o describe lo que necesitas. La IA prepara un borrador para que lo revises antes de publicarlo." },
  "Como deseja começar?": { es: "¿Cómo quieres empezar?" },
  "Modo de criação": { es: "Modo de creación" },
  "Criar com IA": { es: "Crear con IA" },
  "Criar manualmente": { es: "Crear manualmente" },
  "Descreva o fluxo": { es: "Describe el flujo" },
  "Ex: depois de 30 minutos, envie uma mensagem. Se o cliente responder que tem interesse, marque como convertido; se não responder em 24 horas, encerre.": { es: "Ej.: después de 30 minutos, envía un mensaje. Si el cliente responde que está interesado, márcalo como convertido; si no responde en 24 horas, finaliza." },
  "A plataforma usa apenas blocos e operadores compatíveis. Nada entra no ar sem sua revisão.": { es: "La plataforma usa únicamente bloques y operadores compatibles. Nada se activa sin tu revisión." },
  "Gerar rascunho": { es: "Generar borrador" },
  "Ver entradas e webhooks": { es: "Ver entradas y webhooks" },
  "Como ativar a API Oficial": { es: "Cómo activar la API Oficial" },
  "A conexão é sua: a plataforma valida e guarda os dados do seu próprio app da Meta.": { es: "La conexión es tuya: la plataforma valida y guarda los datos de tu propia app de Meta." },
  "Crie ou escolha sua empresa no Meta Business e conclua as verificações solicitadas.": { es: "Crea o elige tu empresa en Meta Business y completa las verificaciones solicitadas." },
  "Crie um app no Meta for Developers e adicione o produto WhatsApp.": { es: "Crea una app en Meta for Developers y añade el producto WhatsApp." },
  "Adicione o número, obtenha a WABA, o ID do número e um token de acesso permanente.": { es: "Añade el número y obtén la WABA, el ID del número y un token de acceso permanente." },
  "Valide os três dados abaixo. Depois copie o webhook mostrado nesta tela para a Meta.": { es: "Valida los tres datos a continuación. Después copia en Meta el webhook que aparece en esta pantalla." },
  "Abrir Meta for Developers": { es: "Abrir Meta for Developers" },
  "Escolha sabendo a diferença": { es: "Elige conociendo la diferencia" },
  "A API Oficial e a conexão por QR continuam separadas em todo o sistema. Um número nunca muda de tecnologia sem você reconectar.": { es: "La API Oficial y la conexión por QR permanecen separadas en todo el sistema. Un número nunca cambia de tecnología sin que vuelvas a conectarlo." },
  "API Oficial da Meta": { es: "API Oficial de Meta" },
  "Recomendada para escala": { es: "Recomendada para escalar" },
  "Canal reconhecido pela plataforma oficial": { es: "Canal reconocido por la plataforma oficial" },
  "Usa templates aprovados fora da janela de atendimento": { es: "Usa plantillas aprobadas fuera de la ventana de atención" },
  "Token guardado cifrado por organização": { es: "Token guardado cifrado por organización" },
  "Exige conta comercial, app e número configurados na Meta. Tarifas e aprovação são definidas pela própria Meta.": { es: "Requiere una cuenta comercial, una app y un número configurados en Meta. Las tarifas y la aprobación las define Meta." },
  "Conexão por QR": { es: "Conexión por QR" },
  "Requer proteção anti-ban": { es: "Requiere protección contra bloqueos" },
  "Pareamento rápido pelo celular": { es: "Vinculación rápida desde el móvil" },
  "Tem aquecimento, limites e ritmo configuráveis": { es: "Tiene calentamiento, límites y ritmo configurables" },
  "Não é a API Oficial e continua sujeito a bloqueios do WhatsApp": { es: "No es la API Oficial y sigue expuesto a bloqueos de WhatsApp" },
  "Use para testes ou operações que aceitam esse risco. A plataforma não promete impedir banimento.": { es: "Úsala para pruebas u operaciones que acepten ese riesgo. La plataforma no promete impedir bloqueos." },
  "Canais conectados": { es: "Canales conectados" },
  "Conectar por QR": { es: "Conectar por QR" },
  Tamanho: { es: "Tamaño" },
  Redimensionar: { es: "Redimensionar" },
  "Ver transcrição": { es: "Ver transcripción" },
  "Não foi possível transcrever este áudio. Ele continua disponível para ouvir.": { es: "No se pudo transcribir este audio. Sigue disponible para escucharlo." },
  "Transcrevendo áudio para a IA…": { es: "Transcribiendo audio para la IA…" },
  "Rascunho criado com IA. Revise antes de publicar.": { es: "Borrador creado con IA. Revísalo antes de publicarlo." },
  Pesquisar: { es: "Buscar" },
  ...
  "Ferramentas não são executadas neste teste. O resultado não comprova consultas, alterações ou transferências reais.": {
    es: "Las herramientas no se ejecutan en esta prueba. El resultado no demuestra consultas, cambios ni transferencias reales.",
  },
  ...
  // Visão geral: dados reais e estados de leitura independentes.
  "Não foi possível carregar esta seção.": { es: "No se pudo cargar esta sección." },
  "Vamos configurar seu negócio?": { es: "¿Configuramos tu negocio?" },
  "SEU NEGÓCIO, MAIS PERTO.": { es: "TU NEGOCIO, MÁS CERCA." },
  "Vamos fazer o dia render?": { es: "¿Aprovechamos el día?" },
  "Acompanhe sua operação": { es: "Sigue tu operación" },
  "Conversas esperando resposta": { es: "Conversaciones esperando respuesta" },
  "conversas esperando resposta": { es: "conversaciones esperando respuesta" },
  "Pipeline de": { es: "Pipeline de" },
  "Pipeline em jogo": { es: "Pipeline en juego" },
  "em jogo": { es: "en juego" },
  "Instâncias conectadas": { es: "Instancias conectadas" },
  "instâncias conectadas": { es: "instancias conectadas" },
  "Abrir a fila": { es: "Abrir la cola" },
  "Revisar funil": { es: "Revisar embudo" },
  "Ver instâncias": { es: "Ver instancias" },
  "Conversas que avançam. Oportunidades que não se perdem.": { es: "Conversaciones que avanzan. Oportunidades que no se pierden." },
  "Abrir conversas": { es: "Abrir conversaciones" },
  "Conversas registradas": { es: "Conversaciones registradas" },
  "Todo o histórico ao qual você tem acesso": { es: "Todo el historial al que tienes acceso" },
  "Na fila": { es: "En espera" },
  "Esperando um atendente no seu escopo": { es: "Esperando un agente dentro de tu alcance" },
  "Com você": { es: "Contigo" },
  "Conversas atribuídas a você e abertas": { es: "Conversaciones abiertas asignadas a ti" },
  "Oportunidades ganhas": { es: "Oportunidades ganadas" },
  "Com responsável · últimos 30 dias": { es: "Con responsable · últimos 30 días" },
  "Tarefas pendentes": { es: "Tareas pendientes" },
  "Pendentes ou em andamento": { es: "Pendientes o en curso" },
  "Não foi possível carregar as contagens.": { es: "No se pudieron cargar los recuentos." },
  "Carregando contagens…": { es: "Cargando recuentos…" },
  "Sua fila de atendimento": { es: "Tu cola de atención" },
  "AGORA É COM VOCÊ": { es: "AHORA TE TOCA" },
  "Acompanhe sua fila de atendimento": { es: "Consulta tu cola de atención" },
  "Sua fila está em dia": { es: "Tu cola está al día" },
  "na fila de atendimento": { es: "en la cola de atención" },
  "Aproveite para acompanhar suas oportunidades e próximos passos.": { es: "Aprovecha para revisar tus oportunidades y próximos pasos." },
  "Seu próximo bom atendimento começa com quem está esperando.": { es: "Tu próxima buena atención empieza con quien está esperando." },
  "Abrir fila": { es: "Abrir cola" },
  "Conversas recentes": { es: "Conversaciones recientes" },
  "Ver todas": { es: "Ver todas" },
  "Abra para ver a conversa": { es: "Abre para ver la conversación" },
  "Nenhuma conversa aberta por aqui.": { es: "No hay conversaciones abiertas aquí." },
  "Ir para conversas": { es: "Ir a conversaciones" },
  "Seu próximo passo": { es: "Tu próximo paso" },
  "Ver tarefas": { es: "Ver tareas" },
  "Não foi possível concluir a tarefa. Tente novamente.": { es: "No se pudo completar la tarea. Inténtalo de nuevo." },
  "Sem prazo definido": { es: "Sin fecha límite" },
  "Nenhuma tarefa pendente. Combine o próximo passo com sua equipe.": { es: "No hay tareas pendientes. Acuerda el próximo paso con tu equipo." },
  "Organizar tarefas": { es: "Organizar tareas" },
  "Seu funil em movimento": { es: "Tu embudo en movimiento" },
  "Ver funis": { es: "Ver embudos" },
  "Oportunidades abertas · conforme seu acesso": { es: "Oportunidades abiertas · según tu acceso" },
  "Total em aberto": { es: "Total abierto" },
  "Desempenho dos últimos 30 dias": { es: "Rendimiento de los últimos 30 días" },
  "IA com o seu jeito": { es: "IA a tu manera" },
  "Você cuida da estratégia. Seu agente ajuda nas conversas.": { es: "Tú te encargas de la estrategia. Tu agente ayuda en las conversaciones." },
  "Habilitado": { es: "Habilitado" },
  "Seu primeiro agente começa com o jeito do seu negócio.": { es: "Tu primer agente empieza con el estilo de tu negocio." },
  "Ver agentes": { es: "Ver agentes" },
  "Seu dia, organizado": { es: "Tu día, organizado" },
  "Veja os compromissos e retome conversas que precisam de atenção.": { es: "Consulta tus citas y retoma las conversaciones que necesitan atención." },
  ...
  // Leitor de site do onboarding: novas chaves ficam no fim para reduzir conflitos.
  "Site do seu negócio (opcional)": { es: "Sitio web de tu negocio (opcional)" },
  "Se você tiver, eu leio e já deixo seu funcionário sabendo o que você vende.": { es: "Si tienes uno, lo leo y preparo a tu empleado para que sepa qué vendes." },
  "Não consigo ler o Instagram ou o Facebook — se tiver um site, cole aqui.": { es: "No puedo leer Instagram ni Facebook; si tienes un sitio web, pégalo aquí." },
  "Não consigo ler este endereço. Use o site público do seu negócio, sem senha, ou deixe em branco.": { es: "No puedo leer esta dirección. Usa el sitio público de tu negocio, sin contraseña, o deja el campo vacío." },
  "Li o seu site ({endereco}). Montei este quadro a partir do que encontrei.": { es: "Leí tu sitio web ({endereco}). Preparé este tablero a partir de lo que encontré." },
  "Também preparei, do seu site:": { es: "También preparé, a partir de tu sitio:" },
  "produtos com preço — aguardando sua conferência": { es: "productos con precio, pendientes de tu revisión" },
  "perguntas frequentes — aguardando sua conferência": { es: "preguntas frecuentes, pendientes de tu revisión" },
  "Revisar agora": { es: "Revisar ahora" },
  "Depois": { es: "Después" },
  "Conferir produtos e preços": { es: "Revisar productos y precios" },
  "Conferir perguntas frequentes": { es: "Revisar preguntas frecuentes" },
  "minhaloja.com.br": { es: "mitienda.com" },
  "Não consegui confirmar os produtos. Tente novamente.": { es: "No pude confirmar los productos. Inténtalo de nuevo." },
  "Produtos confirmados. O atendente já pode consultar os preços.": { es: "Productos confirmados. El asistente ya puede consultar los precios." },
  "Nenhum produto novo para confirmar.": { es: "No hay productos nuevos para confirmar." },
  "Confira os preços encontrados no seu site. O atendente só usa os produtos depois da sua confirmação.": { es: "Revisa los precios encontrados en tu sitio. El asistente solo usa los productos después de tu confirmación." },
  "Confirmando…": { es: "Confirmando…" },
  "Confirmar todos": { es: "Confirmar todos" },
  "Nenhum produto corresponde à busca": { es: "Ningún producto coincide con la búsqueda" },
  "Tente outro nome, código ou marca.": { es: "Prueba con otro nombre, código o marca." },
  "do seu site — confira o preço": { es: "de tu sitio; revisa el precio" },
  "Perguntas do seu site": { es: "Preguntas de tu sitio" },
  "Perguntas encontradas no site do negócio, que só entram no atendimento depois da sua conferência.": { es: "Preguntas encontradas en el sitio del negocio, que solo se usan en la atención después de tu revisión." },
  "O material do site é criado pela leitura do endereço informado na configuração inicial.": { es: "El material del sitio se crea al leer la dirección indicada en la configuración inicial." },
  "O estado da leitura é atualizado pelo sistema. Revise as perguntas para confirmar o material.": { es: "El sistema actualiza el estado de la lectura. Revisa las preguntas para confirmar el material." },
  "Revise as perguntas do site antes de confirmar.": { es: "Revisa las preguntas del sitio antes de confirmar." },
  "Aguarde a leitura terminar antes de revisar as perguntas.": { es: "Espera a que termine la lectura antes de revisar las preguntas." },
  "Não consegui confirmar as perguntas. O material continua sem uso pelo agente.": { es: "No pude confirmar las preguntas. El agente sigue sin usar el material." },
  "Revise e confirme as perguntas do site antes de preparar o material.": { es: "Revisa y confirma las preguntas del sitio antes de preparar el material." },
  "Confira cada resposta antes de permitir que o agente use este material. Os preços dos produtos são confirmados separadamente no catálogo.": { es: "Revisa cada respuesta antes de permitir que el agente use este material. Los precios de los productos se confirman por separado en el catálogo." },
  "Conferi as perguntas e respostas e autorizo o uso pelo agente.": { es: "Revisé las preguntas y respuestas y autorizo que el agente las use." },
  "Confirmar perguntas": { es: "Confirmar preguntas" },
  "Lendo o seu site…": { es: "Leyendo tu sitio…" },
  "Aguardando sua conferência": { es: "Esperando tu revisión" },
  "Leitura concluída": { es: "Lectura completada" },
  "As perguntas do site ainda não são usadas pelo agente. Confira o conteúdo antes de confirmar.": { es: "El agente todavía no usa las preguntas del sitio. Revisa el contenido antes de confirmar." },
  "Não encontrei perguntas frequentes neste site. Você pode adicionar outro material manualmente.": { es: "No encontré preguntas frecuentes en este sitio. Puedes añadir otro material manualmente." },
  "Li até o limite de páginas desta leitura. Você pode completar o conteúdo na revisão.": { es: "Leí hasta el límite de páginas de esta lectura. Puedes completar el contenido al revisarlo." },
  "O que não importei": { es: "Lo que no importé" },
  "Solicitando nova leitura…": { es: "Solicitando otra lectura…" },
  "Tentar ler o site de novo": { es: "Volver a intentar leer el sitio" },
  "Não consegui ler este site após três tentativas. Você pode adicionar o conteúdo manualmente em outro material.": { es: "No pude leer este sitio después de tres intentos. Puedes añadir el contenido manualmente en otro material." },
  "Conferir produtos": { es: "Revisar productos" },
  "Revisar perguntas": { es: "Revisar preguntas" },
  "Não consegui reservar o material para revisão. Tente novamente.": { es: "No pude reservar el material para revisarlo. Inténtalo de nuevo." },
  "Este material mudou em outra aba. Abra a revisão novamente.": { es: "Este material cambió en otra pestaña. Vuelve a abrir la revisión." },
  "Não consegui salvar a revisão inteira. Abra o material e confira as perguntas novamente.": { es: "No pude guardar toda la revisión. Abre el material y revisa las preguntas de nuevo." },
  "As perguntas mudaram depois da conferência. Revise e confirme novamente antes de usar o material.": { es: "Las preguntas cambiaron después de la revisión. Revísalas y confírmalas de nuevo antes de usar el material." },
  "Não consegui reiniciar esta leitura. Confira o estado do material.": { es: "No pude reiniciar esta lectura. Consulta el estado del material." },
  "Não consegui reiniciar esta leitura. Tente novamente.": { es: "No pude reiniciar esta lectura. Inténtalo de nuevo." },
  "O preço tem mais de uma interpretação. Não importei este produto.": { es: "El precio tiene más de una interpretación. No importé este producto." },
  "Encontrei preços diferentes para o mesmo produto. Não importei nenhum deles.": { es: "Encontré precios distintos para el mismo producto. No importé ninguno." },
  "O produto não informa a moeda do preço. Não importei.": { es: "El producto no indica la moneda del precio. No lo importé." },
  "O produto não tem nome suficiente para ser identificado.": { es: "El producto no tiene un nombre suficiente para identificarlo." },
  "Uma parte dos dados deste site está incompleta ou inválida.": { es: "Una parte de los datos de este sitio está incompleta o no es válida." },
  "Este endereço não é um site público permitido. Não fiz a leitura.": { es: "Esta dirección no es un sitio público permitido. No hice la lectura." },
  "O site demorou para responder. Você pode continuar e tentar de novo depois.": { es: "El sitio tardó en responder. Puedes continuar y volver a intentarlo después." },
  "O site não entregou texto que eu consiga ler. Você pode adicionar o conteúdo manualmente.": { es: "El sitio no entregó texto que pueda leer. Puedes añadir el contenido manualmente." },
  "Este endereço não entregou uma página de site legível.": { es: "Esta dirección no entregó una página web legible." },
  "O site está indisponível. Você pode continuar e tentar de novo depois.": { es: "El sitio no está disponible. Puedes continuar y volver a intentarlo después." },
  "Cheguei ao limite de páginas desta leitura e parei.": { es: "Llegué al límite de páginas de esta lectura y me detuve." },
  "Esta página é grande demais. Parei a leitura para manter o sistema disponível.": { es: "Esta página es demasiado grande. Detuve la lectura para mantener el sistema disponible." },
  "O site mudou de endereço vezes demais. Parei a leitura.": { es: "El sitio cambió de dirección demasiadas veces. Detuve la lectura." },
  "O site está redirecionando para ele mesmo. Parei a leitura.": { es: "El sitio se redirige a sí mismo. Detuve la lectura." },
  "Não segui um link que levou para outro site.": { es: "No seguí un enlace que llevaba a otro sitio." },
  "O site indicou um endereço de destino inválido.": { es: "El sitio indicó una dirección de destino no válida." },
  "O endereço do negócio mudou. A leitura anterior não será usada.": { es: "La dirección del negocio cambió. No se usará la lectura anterior." },
  ...
  "Para clínica, consultório, salão e negócios com horário marcado.": { es: "Para clínicas, consultorios, salones y negocios con citas." },
  "Para imobiliária e corretor acompanharem cada interessado.": { es: "Para que inmobiliarias y agentes acompañen a cada interesado." },
  "Para serviços, agência e obra, do pedido ao fechamento.": { es: "Para servicios, agencias y obras, desde la solicitud hasta el cierre." },
  "Para curso, mentoria e infoproduto acompanharem inscrições.": { es: "Para cursos, mentorías e infoproductos que acompañan inscripciones." },
  "Para loja online ou de rua, do contato ao pedido pago.": { es: "Para tiendas online o físicas, desde el contacto hasta el pedido pagado." },
  "Um começo simples para qualquer outro tipo de negócio.": { es: "Un comienzo sencillo para cualquier otro tipo de negocio." },
  "Confirmação": { es: "Confirmación" },
  "Confirme dados, horário ou pedido depois da venda.": { es: "Confirma datos, horarios o pedidos después de la venta." },
  "Entrega de acesso": { es: "Entrega de acceso" },
  "Acompanhe a liberação e o primeiro acesso do cliente.": { es: "Acompaña la habilitación y el primer acceso del cliente." },
  "Suporte pós-venda": { es: "Soporte posventa" },
  "Organize pedidos de ajuda até a resolução.": { es: "Organiza las solicitudes de ayuda hasta su resolución." },
  "Reativação": { es: "Reactivación" },
  "Retome contato com clientes inativos sem misturar vendas novas.": { es: "Retoma el contacto con clientes inactivos sin mezclar ventas nuevas." },
  "A confirmar": { es: "Por confirmar" },
  "Dados conferidos": { es: "Datos revisados" },
  "Precisa de ajuda": { es: "Necesita ayuda" },
  "A liberar": { es: "Por habilitar" },
  "Acesso enviado": { es: "Acceso enviado" },
  "Primeiro acesso": { es: "Primer acceso" },
  "Pendência": { es: "Pendiente" },
  "Nova solicitação": { es: "Nueva solicitud" },
  "Aguardando cliente": { es: "Esperando al cliente" },
  "Para retomar": { es: "Para retomar" },
  "Contato enviado": { es: "Contacto enviado" },
  "Demonstrou interesse": { es: "Mostró interés" },
  "Não quer agora": { es: "No quiere ahora" },
  "Zapfloo — início": { es: "Zapfloo — inicio" },
  "Testar grátis": { es: "Probar gratis" },
  "Atendimento e vendas no WhatsApp": { es: "Atención y ventas por WhatsApp" },
  "A IA atende, qualifica e vende pelo WhatsApp do seu negócio.": { es: "La IA atiende, califica y vende por el WhatsApp de tu negocio." },
  "Para pet shops, clínicas, consultórios e salões organizarem o atendimento sem deixar clientes esperando.": { es: "Para que tiendas de mascotas, clínicas, consultorios y salones organicen la atención sin dejar esperando a sus clientes." },
  "Testar grátis por 7 dias": { es: "Probar gratis durante 7 días" },
  "Falar pelo WhatsApp": { es: "Hablar por WhatsApp" },
  "Atendimento em andamento": { es: "Atención en curso" },
  "Oi! Quais horários vocês têm amanhã?": { es: "¡Hola! ¿Qué horarios tienen mañana?" },
  "Temos horários às 10h e 15h. Qual fica melhor para você?": { es: "Tenemos horarios a las 10 y a las 15. ¿Cuál te viene mejor?" },
  "Organizado automaticamente": { es: "Organizado automáticamente" },
  "Cliente qualificado · aguardando escolha do horário": { es: "Cliente calificado · esperando que elija un horario" },
  "Simples desde o primeiro dia": { es: "Sencillo desde el primer día" },
  "Como funciona": { es: "Cómo funciona" },
  "Conecte seu número": { es: "Conecta tu número" },
  "Escolha a conexão disponível para o seu negócio e veja o estado dela na tela.": { es: "Elige la conexión disponible para tu negocio y consulta su estado en la pantalla." },
  "Ensine o seu atendimento": { es: "Enseña cómo atiende tu negocio" },
  "Informe serviços, horários e regras. O Zapfloo organiza tudo com você.": { es: "Informa servicios, horarios y reglas. Zapfloo lo organiza todo contigo." },
  "Comece a atender": { es: "Empieza a atender" },
  "Acompanhe conversas, agenda e funil enquanto a IA cuida das respostas permitidas.": { es: "Sigue las conversaciones, la agenda y el embudo mientras la IA se ocupa de las respuestas permitidas." },
  "Um atendimento que continua": { es: "Una atención que continúa" },
  "Da primeira dúvida ao próximo passo do cliente": { es: "Desde la primera duda hasta el próximo paso del cliente" },
  "Responde na hora": { es: "Responde al instante" },
  "Tira dúvidas com o seu catálogo": { es: "Resuelve dudas con tu catálogo" },
  "Marca horário": { es: "Programa citas" },
  "Retoma quem sumiu": { es: "Retoma el contacto con quien dejó de responder" },
  "Organiza o funil": { es: "Organiza el embudo" },
  "Planos mensais": { es: "Planes mensuales" },
  "Escolha o espaço que o seu atendimento precisa": { es: "Elige la capacidad que necesita tu atención" },
  "por mês": { es: "al mes" },
  "Perguntas frequentes": { es: "Preguntas frecuentes" },
  "O teste libera quais recursos?": { es: "¿Qué recursos incluye la prueba?" },
  "Durante os 7 dias de teste, você usa os recursos do plano Completo.": { es: "Durante los 7 días de prueba, usas los recursos del plan Completo." },
  "O que acontece quando o teste termina?": { es: "¿Qué ocurre cuando termina la prueba?" },
  "O CRM e seus dados continuam disponíveis. A IA fica pausada até a ativação de um plano.": { es: "El CRM y tus datos siguen disponibles. La IA queda pausada hasta que actives un plan." },
  "Como o WhatsApp é conectado?": { es: "¿Cómo se conecta WhatsApp?" },
  "A plataforma diferencia a API Oficial da Meta e a conexão por QR. Você escolhe a opção disponível para a sua operação.": { es: "La plataforma diferencia la API oficial de Meta de la conexión por QR. Eliges la opción disponible para tu operación." },
  "Preciso montar o funil do zero?": { es: "¿Tengo que crear el embudo desde cero?" },
  "Não. Há modelos prontos por tipo de negócio e para etapas de pós-venda; você pode ajustá-los depois.": { es: "No. Hay modelos listos por tipo de negocio y para etapas de posventa; puedes ajustarlos después." },
  "Seu atendimento pode começar hoje.": { es: "Tu atención puede empezar hoy." },
  "Configure o negócio, conecte o WhatsApp e veja o funcionário responder antes de colocá-lo no ar.": { es: "Configura el negocio, conecta WhatsApp y comprueba cómo responde el asistente antes de ponerlo en funcionamiento." },
  "Zapfloo · atendimento e vendas no WhatsApp": { es: "Zapfloo · atención y ventas por WhatsApp" },
  "Documentos legais": { es: "Documentos legales" },
  "Termos de uso": { es: "Términos de uso" },
  "Privacidade": { es: "Privacidad" },
  "Atendente de IA para WhatsApp": { es: "Asistente de IA para WhatsApp" },
  "Seu WhatsApp responde, agenda e vende, mesmo quando você está ocupado.": { es: "Tu WhatsApp responde, agenda y vende, incluso cuando estás ocupado." },
  "O Zapfloo coloca uma atendente de IA no WhatsApp do seu pet shop, clínica ou salão. Ela tira dúvidas com os seus preços, marca horário e chama de volta quem sumiu. Você só entra na conversa quando precisar.": { es: "Zapfloo pone una asistente de IA en el WhatsApp de tu tienda de mascotas, clínica o salón. Resuelve dudas con tus precios, programa citas y vuelve a contactar a quienes dejaron de responder. Solo entras en la conversación cuando lo necesitas." },
  "Todos os recursos liberados no teste. Sem cartão de crédito.": { es: "Todos los recursos disponibles durante la prueba. Sin tarjeta de crédito." },
  "Cada mensagem sem resposta é um cliente indo pro concorrente": { es: "Cada mensaje sin respuesta es un cliente que se va a la competencia" },
  "O cliente pergunta o preço, você está no meio de um atendimento, e quando responde ele já marcou em outro lugar.": { es: "El cliente pregunta el precio, estás atendiendo a otra persona y, cuando respondes, ya reservó en otro lugar." },
  "Muita conversa começa com um \"oi\" e morre ali, porque ninguém chama de volta.": { es: "Muchas conversaciones empiezan con un \"hola\" y terminan ahí porque nadie retoma el contacto." },
  "A agenda vive espalhada entre o WhatsApp, o caderno e a memória.": { es: "La agenda está repartida entre WhatsApp, el cuaderno y la memoria." },
  "Pronto pra atender em poucos passos": { es: "Listo para atender en pocos pasos" },
  "Conecte o seu WhatsApp": { es: "Conecta tu WhatsApp" },
  "Leia um QR Code com o celular do negócio, igual ao WhatsApp Web.": { es: "Escanea un código QR con el celular del negocio, igual que en WhatsApp Web." },
  "Conte como o seu negócio funciona": { es: "Cuenta cómo funciona tu negocio" },
  "Serviços, preços, horários e regras. Se você tiver site, a gente lê e adianta essa parte pra você.": { es: "Servicios, precios, horarios y reglas. Si tienes un sitio web, lo leemos y adelantamos esta parte por ti." },
  "Deixe a IA atender": { es: "Deja que la IA atienda" },
  "Ela responde, agenda e organiza cada cliente. Você acompanha tudo numa tela só e assume qualquer conversa quando quiser.": { es: "Responde, agenda y organiza a cada cliente. Puedes seguirlo todo en una sola pantalla y tomar cualquier conversación cuando quieras." },
  "Uma atendente que não esquece ninguém": { es: "Una asistente que no se olvida de nadie" },
  "Nada de cliente esperando enquanto você atende outra pessoa.": { es: "Sin clientes esperando mientras atiendes a otra persona." },
  "Tira dúvidas com os seus preços": { es: "Resuelve dudas con tus precios" },
  "Usa o seu catálogo e as informações que você cadastrou.": { es: "Usa tu catálogo y la información que registraste." },
  "Consulta os horários livres e agenda direto na conversa.": { es: "Consulta los horarios disponibles y agenda directamente en la conversación." },
  "Chama de volta quem sumiu": { es: "Vuelve a contactar a quienes dejaron de responder" },
  "Manda mensagem na hora certa pra quem parou de responder.": { es: "Envía un mensaje en el momento adecuado a quienes dejaron de responder." },
  "Organiza tudo sozinha": { es: "Lo organiza todo sola" },
  "Cada cliente vai pra etapa certa: novo, interessado, agendado, fechado.": { es: "Cada cliente pasa a la etapa correcta: nuevo, interesado, agendado, cerrado." },
  "Passa pra você quando precisa": { es: "Te pasa la conversación cuando hace falta" },
  "Casos delicados vão pra uma pessoa da equipe, com a conversa inteira.": { es: "Los casos delicados pasan a una persona del equipo, con toda la conversación." },
  "Escolha o plano do tamanho do seu negócio": { es: "Elige el plan a la medida de tu negocio" },
  "Comece com 7 dias grátis em qualquer um. Troque de plano quando quiser.": { es: "Empieza con 7 días gratis en cualquiera de ellos. Cambia de plan cuando quieras." },
  "Pra quem atende sozinho e quer parar de perder mensagem.": { es: "Para quienes atienden solos y quieren dejar de perder mensajes." },
  "{numerosWhatsapp} WhatsApp": { es: "{numerosWhatsapp} WhatsApp" },
  "{funcionariosIa} atendente de IA": { es: "{funcionariosIa} asistente de IA" },
  "{usuarios} pessoa da equipe com acesso": { es: "{usuarios} persona del equipo con acceso" },
  "{funis} quadro de vendas": { es: "{funis} tablero de ventas" },
  "Agenda, catálogo com preços e respostas sobre o seu negócio": { es: "Agenda, catálogo con precios y respuestas sobre tu negocio" },
  "Configuração a partir do seu site": { es: "Configuración a partir de tu sitio web" },
  "Recomendado": { es: "Recomendado" },
  "Pra quem tem equipe pequena e quer recuperar cliente que sumiu.": { es: "Para quienes tienen un equipo pequeño y quieren recuperar a los clientes que dejaron de responder." },
  "Tudo do Básico, e mais:": { es: "Todo lo del Básico, y además:" },
  "{usuarios} pessoas da equipe com acesso": { es: "{usuarios} personas del equipo con acceso" },
  "{funis} quadros de vendas": { es: "{funis} tableros de ventas" },
  "Mensagem automática pra quem parou de responder": { es: "Mensaje automático para quienes dejaron de responder" },
  "Horários sincronizados com o Google Agenda": { es: "Horarios sincronizados con Google Calendar" },
  "Pra quem quer automatizar do primeiro contato ao pós-venda.": { es: "Para quienes quieren automatizar desde el primer contacto hasta la posventa." },
  "Tudo do Essencial, e mais:": { es: "Todo lo del Esencial, y además:" },
  "Até {numerosWhatsapp} WhatsApps e {funcionariosIa} atendentes de IA": { es: "Hasta {numerosWhatsapp} WhatsApps y {funcionariosIa} asistentes de IA" },
  "Quadros sem limite: vendas, confirmação, entrega e pós-venda": { es: "Tableros sin límite: ventas, confirmación, entrega y posventa" },
  "Aviso de clientes que estão esfriando": { es: "Aviso de clientes que están perdiendo interés" },
  "Integração com outros sistemas": { es: "Integración con otros sistemas" },
  "/mês": { es: "/mes" },
  "Preciso entender de tecnologia?": { es: "¿Necesito saber de tecnología?" },
  "Não. A configuração é feita com perguntas simples, e se você tiver site, a gente aproveita as informações dele.": { es: "No. La configuración se hace con preguntas sencillas y, si tienes un sitio web, aprovechamos su información." },
  "A IA pode falar besteira pro meu cliente?": { es: "¿La IA puede decirle algo incorrecto a mi cliente?" },
  "Ela só responde com base no que você cadastrou e confere cada mensagem antes de enviar. Preço e informação que vêm do seu site só passam a valer depois que você aprova. E você pode assumir qualquer conversa a qualquer momento.": { es: "Solo responde basándose en lo que registraste y revisa cada mensaje antes de enviarlo. Los precios y la información de tu sitio web solo se usan después de que los apruebes. Y puedes tomar cualquier conversación en cualquier momento." },
  "O que o teste grátis inclui?": { es: "¿Qué incluye la prueba gratis?" },
  "7 dias com todos os recursos do plano Completo. Não pedimos cartão.": { es: "7 días con todos los recursos del plan Completo. No pedimos tarjeta." },
  "E quando o teste acaba?": { es: "¿Y cuando termina la prueba?" },
  "Seus dados continuam lá. A atendente de IA pausa até você escolher um plano.": { es: "Tus datos siguen ahí. La asistente de IA se pausa hasta que elijas un plan." },
  "Funciona com o número que eu já uso?": { es: "¿Funciona con el número que ya uso?" },
  "Sim. Você conecta o WhatsApp que já usa no negócio.": { es: "Sí. Conectas el WhatsApp que ya usas en tu negocio." },
  "Posso trocar de plano depois?": { es: "¿Puedo cambiar de plan después?" },
  "Pode, pra cima ou pra baixo, e nada do que você já tem é apagado.": { es: "Puedes subir o bajar de plan y no se borra nada de lo que ya tienes." },
  "Teste por 7 dias e veja a IA atendendo o seu cliente de verdade.": { es: "Prueba durante 7 días y ve cómo la IA atiende a tu cliente de verdad." },
  "Sem cartão de crédito.": { es: "Sin tarjeta de crédito." },
  "Zapfloo — Atendente de IA para o WhatsApp do seu negócio": { es: "Zapfloo — Asistente de IA para el WhatsApp de tu negocio" },
  "A IA responde, marca horário e chama de volta quem sumiu no WhatsApp do seu pet shop, clínica ou salão. Teste grátis por 7 dias.": { es: "La IA responde, programa citas y vuelve a contactar a quienes dejaron de responder en el WhatsApp de tu tienda de mascotas, clínica o salón. Prueba gratis durante 7 días." },
  "A IA está indisponível no momento; já avisamos o suporte.": { es: "La IA no está disponible en este momento; ya avisamos al soporte." },
  "O modelo de IA não está disponível agora. Tentamos uma alternativa; você pode continuar e testar novamente depois.": { es: "El modelo de IA no está disponible ahora. Probamos una alternativa; puedes continuar y volver a probar más tarde." },
  "A IA demorou mais que o esperado. Você pode continuar e testar novamente depois.": { es: "La IA tardó más de lo esperado. Puedes continuar y volver a probar más tarde." },
  "A resposta da IA foi interrompida antes de terminar. Você pode continuar e testar novamente depois.": { es: "La respuesta de la IA se interrumpió antes de terminar. Puedes continuar y volver a probar más tarde." },
  "A IA não devolveu uma resposta desta vez. Você pode continuar e testar novamente depois.": { es: "La IA no devolvió una respuesta esta vez. Puedes continuar y volver a probar más tarde." },
  "A IA da plataforma está indisponível no momento; já avisamos o suporte.": { es: "La IA de la plataforma no está disponible en este momento; ya avisamos al soporte." },
  "O ensaio está indisponível porque o limite de uso de IA foi atingido.": { es: "El ensayo no está disponible porque se alcanzó el límite de uso de IA." },
  "O agente continuará desligado até um ensaio funcionar e você concluir a ativação.": { es: "El agente seguirá apagado hasta que un ensayo funcione y completes la activación." },
  "Continuar para conexão com a IA desligada": { es: "Continuar a la conexión con la IA apagada" },
  "Você pode conectar o WhatsApp agora. A IA continuará desligada até o ensaio funcionar e você concluir a ativação.": { es: "Puedes conectar WhatsApp ahora. La IA seguirá apagada hasta que el ensayo funcione y completes la activación." },
  "A conexão pode ser preparada, mas a IA não será liberada enquanto o ensaio estiver indisponível.": { es: "La conexión puede prepararse, pero la IA no se habilitará mientras el ensayo no esté disponible." },
  "Voltar e testar a IA novamente": { es: "Volver a probar la IA" },
  "Carregando estado da IA…": { es: "Cargando el estado de la IA…" },
  "Não foi possível confirmar se a IA está atendendo.": { es: "No fue posible confirmar si la IA está atendiendo." },
  "IA atendendo todos": { es: "IA atendiendo a todos" },
  "IA em teste": { es: "IA en prueba" },
  "IA desligada": { es: "IA apagada" },
  "número autorizado": { es: "número autorizado" },
  "números autorizados": { es: "números autorizados" },
  "nenhum agente publicado": { es: "ningún agente publicado" },
  "WhatsApp desconectado": { es: "WhatsApp desconectado" },
  "a IA está indisponível no momento; já avisamos o suporte": { es: "la IA no está disponible en este momento; ya avisamos al soporte" },
  "estado indisponível": { es: "estado no disponible" },
  "Estado do atendimento por IA": { es: "Estado de la atención por IA" },
  "Fora da lista autorizada, as mensagens chegam ao Inbox sem resposta automática.": { es: "Fuera de la lista autorizada, los mensajes llegan al Inbox sin respuesta automática." },
  "Liberar para todos": { es: "Habilitar para todos" },
  "Autorizar números": { es: "Autorizar números" },
  "Corrigir agora": { es: "Corregir ahora" },
  "Liberar a IA para todos?": { es: "¿Habilitar la IA para todos?" },
  "A IA poderá responder qualquer pessoa que enviar mensagem nova neste canal. Mensagens antigas não serão respondidas por esta ação.": { es: "La IA podrá responder a cualquier persona que envíe un mensaje nuevo en este canal. Esta acción no responderá mensajes antiguos." },
  "Não foi possível liberar a IA. Abra Conexões e confira o canal.": { es: "No fue posible habilitar la IA. Abre Conexiones y revisa el canal." },
  "Liberando…": { es: "Habilitando…" },
  "Conectar com Facebook": { es: "Conectar con Facebook" },
  "Conectar a conta de anúncios": { es: "Conectar la cuenta publicitaria" },
  "Entre com o Facebook e autorize a leitura das contas de anúncios. Suas campanhas não serão alteradas.": { es: "Entra con Facebook y autoriza la lectura de las cuentas publicitarias. Tus campañas no se modificarán." },
  "Conexão autorizada. Escolha a conta de anúncios padrão abaixo.": { es: "Conexión autorizada. Elige la cuenta publicitaria predeterminada abajo." },
  "A autorização não foi concluída. Use Conectar com Facebook para começar novamente.": { es: "La autorización no se completó. Usa Conectar con Facebook para empezar de nuevo." },
  "Gerando link…": { es: "Generando enlace…" },
  "Gerar link de conexão": { es: "Generar enlace de conexión" },
  "Quem cuida dos seus anúncios pode autorizar pelo link sem entrar no CRM. Compartilhe somente com quem administra a conta de anúncios.": { es: "Quien se encarga de tus anuncios puede autorizar mediante el enlace sin entrar al CRM. Compártelo solo con quien administra la cuenta publicitaria." },
  "Link para quem cuida dos anúncios": { es: "Enlace para quien se encarga de los anuncios" },
  "Este link expira em {data}.": { es: "Este enlace vence el {data}." },
  "Link de conexão copiado.": { es: "Enlace de conexión copiado." },
  "Não consegui copiar automaticamente. Selecione e copie o link exibido.": { es: "No pude copiarlo automáticamente. Selecciona y copia el enlace que se muestra." },
  "Não consegui gerar o link de conexão. Tente novamente.": { es: "No pude generar el enlace de conexión. Inténtalo de nuevo." },
  "Conta de anúncios padrão": { es: "Cuenta publicitaria predeterminada" },
  "Carregando contas de anúncios…": { es: "Cargando cuentas publicitarias…" },
  "Escolha uma conta de anúncios": { es: "Elige una cuenta publicitaria" },
  "Nenhuma conta de anúncios disponível nesta autorização.": { es: "No hay cuentas publicitarias disponibles con esta autorización." },
  "Salvar conta padrão": { es: "Guardar cuenta predeterminada" },
  "Atualizar contas de anúncios": { es: "Actualizar cuentas publicitarias" },
  "Conta padrão salva.": { es: "Cuenta predeterminada guardada." },
  "Não consegui carregar as contas de anúncios. Tente novamente.": { es: "No pude cargar las cuentas publicitarias. Inténtalo de nuevo." },
  "Não consegui salvar a conta padrão. Tente novamente.": { es: "No pude guardar la cuenta predeterminada. Inténtalo de nuevo." },
  "Conecte sua conta de anúncios com o Facebook ou gere um link para quem cuida dos anúncios autorizar. Esta conexão permite apenas ler o desempenho das campanhas.": { es: "Conecta tu cuenta publicitaria con Facebook o genera un enlace para que autorice quien se encarga de los anuncios. Esta conexión solo permite leer el rendimiento de las campañas." },
  "A conexão automática não está disponível nesta instalação. Peça a quem administra a organização para configurar a conexão manual.": { es: "La conexión automática no está disponible en esta instalación. Pide a quien administra la organización que configure la conexión manual." },
  "A autorização da conta de anúncios venceu. Conecte novamente para voltar a consultar as campanhas.": { es: "La autorización de la cuenta publicitaria venció. Vuelve a conectarla para consultar las campañas." },
  "A autorização da conta de anúncios vence em até 7 dias. Conecte novamente para evitar uma interrupção.": { es: "La autorización de la cuenta publicitaria vence en un máximo de 7 días. Vuelve a conectarla para evitar una interrupción." },
  "A validade desta autorização não foi informada. Isso não significa acesso permanente; se a leitura parar, conecte novamente.": { es: "No se informó la vigencia de esta autorización. Esto no significa acceso permanente; si la lectura se interrumpe, vuelve a conectarla." },
  "Revisar conexão de anúncios": { es: "Revisar conexión publicitaria" },
  "Conecte a conta de anúncios em Configurações para ver as campanhas aqui.": { es: "Conecta la cuenta publicitaria en Configuración para ver las campañas aquí." },
  "Este link de conexão está indisponível. Peça um novo link à pessoa responsável.": { es: "Este enlace de conexión no está disponible. Pide un enlace nuevo a la persona responsable." },
  "A conexão está temporariamente indisponível. Tente novamente mais tarde.": { es: "La conexión no está disponible temporalmente. Inténtalo de nuevo más tarde." },
  "Conexão concluída": { es: "Conexión completada" },
  "As contas de anúncio foram conectadas. Você pode fechar esta página.": { es: "Las cuentas publicitarias se conectaron. Puedes cerrar esta página." },
  "Conexão cancelada": { es: "Conexión cancelada" },
  "A autorização foi cancelada. Peça um novo link à pessoa responsável para tentar novamente.": { es: "La autorización se canceló. Pide un enlace nuevo a la persona responsable para intentarlo de nuevo." },
  "Não foi possível conectar": { es: "No se pudo conectar" },
  "A conexão não foi concluída. Peça um novo link à pessoa responsável e tente novamente.": { es: "La conexión no se completó. Pide un enlace nuevo a la persona responsable e inténtalo de nuevo." },
  "Origem da solicitação não autorizada.": { es: "Origen de la solicitud no autorizado." },
  "Muitas tentativas. Aguarde um minuto e tente novamente.": { es: "Demasiados intentos. Espera un minuto e inténtalo de nuevo." },
  "Esta sessão precisa da verificação em duas etapas.": { es: "Esta sesión requiere verificación en dos pasos." },
  "A conexão automática não está disponível nesta instalação.": { es: "La conexión automática no está disponible en esta instalación." },
  "Não foi possível gerar o link. Tente novamente.": { es: "No se pudo generar el enlace. Inténtalo de nuevo." },
  ...
  "Informe o endereço do site.": { es: "Informa la dirección del sitio web." },
  "Site adicionado. A leitura segura começou e você poderá conferir tudo antes de usar.": { es: "Sitio añadido. La lectura segura comenzó y podrás revisar todo antes de usarlo." },
  "Site": { es: "Sitio web" },
  "Informações encontradas no endereço do seu negócio, que só entram no atendimento depois da sua conferência.": { es: "Información encontrada en el sitio de tu negocio, que solo se usa en la atención después de tu revisión." },
  "Endereço do site": { es: "Dirección del sitio web" },
  "Lemos as páginas públicas com a mesma proteção usada na configuração inicial. Nada entra no atendimento sem a sua conferência.": { es: "Leemos las páginas públicas con la misma protección usada en la configuración inicial. Nada entra en la atención sin tu revisión." },
  "Última leitura": { es: "Última lectura" },
  "Ler de novo": { es: "Leer de nuevo" },
  "Informe um endereço de site válido.": { es: "Informa una dirección de sitio válida." },
  "Não consegui colocar o site na fila de leitura.": { es: "No pude poner el sitio en la cola de lectura." },
  "Este endereço não pode ser lido com segurança.": { es: "Esta dirección no puede leerse de forma segura." },
  "Para adicionar um site, informe o endereço no leitor seguro do acervo.": { es: "Para añadir un sitio, informa la dirección en el lector seguro del acervo." },
  "Entra quando o cliente falar:": { es: "Entra cuando el cliente diga:" },
  "Esta skill não informa palavras de entrada.": { es: "Esta skill no informa palabras de entrada." },
  "Quase entrou": { es: "Casi entró" },
  "vez": { es: "vez" },
  "vezes": { es: "veces" },
  "Isso mostra onde os gatilhos podem ser melhorados, sem revelar a conversa.": { es: "Esto muestra dónde se pueden mejorar los disparadores, sin revelar la conversación." },
  "Produto e preço": { es: "Producto y precio" },
  "Sem preço definido": { es: "Sin precio definido" },
  "Criar um produto com nome e preço": { es: "Crear un producto con nombre y precio" },
  "Nome do novo produto": { es: "Nombre del nuevo producto" },
  "Preço do novo produto": { es: "Precio del nuevo producto" },
  "Nome do produto": { es: "Nombre del producto" },
  "Criar produto": { es: "Crear producto" },
  "Produto criado e selecionado.": { es: "Producto creado y seleccionado." },
  "Informe o nome e um preço válido.": { es: "Informa el nombre y un precio válido." },
  "Escolha quem a IA vai atender": { es: "Elige a quién atenderá la IA" },
  "Conectar não ativa o agente. Você decide o alcance antes da primeira resposta automática.": { es: "Conectar no activa al agente. Tú decides el alcance antes de la primera respuesta automática." },
  "Alcance inicial da IA": { es: "Alcance inicial de la IA" },
  "Atender só os meus números de teste": { es: "Atender solo mis números de prueba" },
  "Canal que a IA vai atender": { es: "Canal que atenderá la IA" },
  "Clientes continuam chegando ao Inbox, mas só os números autorizados recebem resposta da IA.": { es: "Los clientes siguen llegando a la bandeja, pero solo los números autorizados reciben respuesta de la IA." },
  "Atender todos os clientes": { es: "Atender a todos los clientes" },
  "Depois da ativação, toda mensagem nova elegível poderá receber resposta da IA.": { es: "Después de la activación, cada mensaje nuevo elegible podrá recibir respuesta de la IA." },
  "Ativar e atender todos": { es: "Activar y atender a todos" },
  "Agente ativado para todos os clientes. Mensagens antigas não serão respondidas.": { es: "Agente activado para todos los clientes. Los mensajes antiguos no serán respondidos." },
  "Liberar para todos agora": { es: "Habilitar para todos ahora" },
  "O agente foi ativado em modo de teste, mas não foi possível liberar para todos. Tente novamente pelo botão abaixo.": { es: "El agente se activó en modo de prueba, pero no fue posible habilitarlo para todos. Inténtalo de nuevo con el botón de abajo." },
  "Criar um funil novo com este modelo": { es: "Crear un embudo nuevo con este modelo" },
  "O funil atual e os clientes que já estão nele não serão alterados.": { es: "El embudo actual y los clientes que ya están en él no se modificarán." },
  "Leitor": { es: "Lector" },
  "membro": { es: "miembro" },
  ...
  "Valor informado dos negócios ganhos fechados neste mês.": {
    es: "Valor informado de los negocios ganados cerrados este mes.",
  },
  "Valor informado ganho dividido pelos negócios ganhos com valor informado.": {
    es: "Valor informado ganado dividido entre los negocios ganados con valor informado.",
  },
