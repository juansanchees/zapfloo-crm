...
export const DICIONARIO: Traducoes = {
  ...
  "Adiando IA…": { es: "Posponiendo la IA…" },
  "A organização ativa mudou. Recarregue esta etapa antes de adiar a IA.": { es: "La organización activa cambió. Recarga esta etapa antes de posponer la IA." },
  "Recarregar esta etapa": { es: "Recargar esta etapa" },
