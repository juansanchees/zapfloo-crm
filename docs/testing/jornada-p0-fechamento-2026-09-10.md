...
| Proteção do QR temporário0700/0600, validação de cleanup e bloqueio de snapshots sensíveis; sonda Chromium real comprovou captura sem guard e ausência com guard. Preflight corrigido400→200, com gate AST/schema e re-review. | Persistir também os JSONs numéricos de medidas, hoje anexados em memória no reporter list; conferir o término do observador de QR quando a imagem desaparece. | Nenhum segredo/QR bruto está incluído nos artefatos versionáveis. |
