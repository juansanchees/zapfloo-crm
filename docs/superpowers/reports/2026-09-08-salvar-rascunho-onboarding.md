...
- Capturas `evidence/onboarding/rascunho-desktop.png`, `evidence/onboarding/rascunho-celular.png` e `evidence/onboarding/rascunho-salvo-celular.png` inspecionadas. Campos retomados, botão/status legíveis, sem overflow horizontal em 390px. Tema/marca padrão do fixture local: não representam alteração da identidade da produção.
